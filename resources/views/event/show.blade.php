...
<div class="card">
    <div class="card-body">
        ...
        <div class="text-right mb-3">
            <a href="{{route('events.guests', ['event' => $eventosID->id])}}" class="btn btn-light">Lista de Invitados</a>
            <a href="{{route('events.photographers', ['event' => $eventosID->id])}}" class="btn btn-light">Lista de Fotógrafos</a>
        </div>
